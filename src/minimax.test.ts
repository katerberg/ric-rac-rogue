...
import {Choice, Coordinate, State, TurnOrderType} from './types';
...
describe('minimax', () => {
  describe('getBestMove', () => {
    it('finds a winning terminal move for x', () => {
      ...
      const result = getBestMove(input, false, TurnOrderType.TAKE_TURNS);
    ...
    it.skip('finds a winning terminal move for o', () => {
      ...
      const result = getBestMove(input, true, TurnOrderType.TAKE_TURNS);
